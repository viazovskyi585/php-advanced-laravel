						...
						<thead class="align-bottom">
							<tr>
								...
								<th
									...
									Title</th>
								<th
									class="border-b-solid whitespace-nowrap border-b border-gray-200 bg-transparent px-4 py-3 text-center align-middle text-xs font-bold uppercase tracking-none text-slate-400 opacity-70 shadow-none">
									SKU</th>
								<th
									class="border-b-solid whitespace-nowrap border-b border-gray-200 bg-transparent px-4 py-3 text-center align-middle text-xs font-bold uppercase tracking-none text-slate-400 opacity-70 shadow-none">
									Categories</th>
								<th
									class="border-b-solid whitespace-nowrap border-b border-gray-200 bg-transparent px-4 py-3 text-right align-middle text-xs font-bold uppercase tracking-none text-slate-400 opacity-70 shadow-none">
									Discount</th>
								<th
									class="border-b-solid whitespace-nowrap border-b border-gray-200 bg-transparent px-4 py-3 text-right align-middle text-xs font-bold uppercase tracking-none text-slate-400 opacity-70 shadow-none">
									Price</th>
							...
							@foreach ($products as $product)
								<tr>
									<td class="border-b bg-transparent p-2 align-middle shadow-transparent">
										<div class="px-2 py-1">
											<img class="h-10 w-30 rounded-2 object-cover object-center" src="{{ $product->thumbnail_url }}"
												alt="{{ $product->title }}">
										</div>
									</td>
									<td class="border-b bg-transparent p-2 align-middle shadow-transparent">
