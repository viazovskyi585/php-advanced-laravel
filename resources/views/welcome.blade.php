					...
					<a
						...
						<div>
							<div class="flex h-16 w-16 items-center justify-center rounded-full bg-red-50 dark:bg-red-800/20">
								<svg class="h-7 w-7 stroke-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
									stroke-width="1.5">
						...
						<svg class="mx-6 h-6 w-6 shrink-0 self-center stroke-red-500" xmlns="http://www.w3.org/2000/svg" fill="none"
						...
						<div>
							...
							<p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
								Laravel's robust library of first-party tools and libraries, such as <a
									...
									class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
									href="https://envoyer.io">Envoyer</a> help you take your projects to the next level. Pair them with powerful
